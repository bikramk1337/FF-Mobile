      ...
      <View>
        ...
        {image ? (
          ...
          >
            ...
            <Card.Actions>
              <Button
                theme={{
                  colors: {
                    primary: colors.textAndIcons,
                    outline: colors.textAndIcons,
                  },
                }}
              ...
              <Button
                theme={{ colors: { primary: colors.textAndIcons } }}
                onPress={() =>
                  alert(
                    "Your image has been sent for animal detection.Results will be displayed shortly."
                  )
                }
              >
                Detect Animal
          ...
          <View style={styles.textContainer}>
            ...
            >
              {" "}
              Uncover the Wild: A Click Away from Nature's Wonders
            </Text>
          </View>
        )}
      </View>
